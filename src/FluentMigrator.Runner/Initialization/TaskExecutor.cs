...
namespace FluentMigrator.Runner.Initialization
{
    public class TaskExecutor
    {
        ...
        {
            var manager = new ConnectionStringManager(new NetConfigManager(), RunnerContext.Announcer,
                RunnerContext.Connection, RunnerContext.ConnectionStringConfigPath, assemblyLocation,
                RunnerContext.Database, RunnerContext.DoNotAnnounceConnectionString);
